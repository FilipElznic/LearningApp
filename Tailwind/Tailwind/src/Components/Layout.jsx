  ...
  return (
    <>
      <div className=" w-full px-4 sm:px-6 lg:px-8 xl:w-2/3 h-full mt-24 sm:mt-32 md:mt-40 lg:mt-48  bg-white">
        <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-7xl font-bold">
        ...
        <p className="text-lg sm:text-xl md:text-2xl w-full sm:w-3/4 md:w-2/3 lg:w-1/2 mt-6 sm:mt-8 font-extralight text-gray-900">
          Discover the wonders of space—from Earth to the Moon, and beyond. Tap
          into immersive lessons on astronauts, rockets, and our cosmic
          neighborhood.
        </p>
        ...
        <div className="w-full h-full mt-8 sm:mt-10 flex flex-col gap-3 sm:gap-4 group/sections">
          <div className="w-full flex flex-col sm:flex-row gap-3 sm:gap-4">
            <div
              className="group/item w-full sm:w-1/3 h-[30vh] sm:h-[35vh] md:h-[40vh] rounded-2xl sm:rounded-3xl blackgradient relative z-10 cursor-pointer transition-all duration-300 group-hover/sections:brightness-50 group-hover/sections:opacity-70 hover:!brightness-100 hover:!opacity-100 hover:scale-105 hover:z-20"
              onClick={() => {
            ...
            <div
              className="group/item w-full sm:w-2/3 h-[30vh] sm:h-[35vh] md:h-[40vh] rounded-2xl sm:rounded-3xl blackgradient relative z-10 cursor-pointer transition-all duration-300 group-hover/sections:brightness-50 group-hover/sections:opacity-70 hover:!brightness-100 hover:!opacity-100 hover:scale-105 hover:z-20"
              onClick={() => {
